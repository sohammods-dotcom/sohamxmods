const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-BV07y8n2.js","assets/dialog-iXX3EY0W.js","assets/shield-C0jHGABo.js","assets/useApps-Dp3DwtGU.js","assets/Layout-C8PHEOpx.js","assets/AppDetailPage-Dd_fsyJ0.js","assets/badge-DNNtDM6x.js","assets/button-cFVUO7n4.js","assets/AdminLoginPage-Vy5eA9p3.js","assets/useAdminAuth-rWuVu_M1.js","assets/AdminDashboardPage-C60rWNhn.js"])))=>i.map(i=>d[i]);
...
const HomePage = reactExports.lazy(
  () => __vitePreload(() => import("./HomePage-BV07y8n2.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0).then((m) => ({ default: m.HomePage }))
);
const AppDetailPage = reactExports.lazy(
  () => __vitePreload(() => import("./AppDetailPage-Dd_fsyJ0.js"), true ? __vite__mapDeps([5,6,2,7,4,3]) : void 0).then((m) => ({ default: m.AppDetailPage }))
);
const AdminLoginPage = reactExports.lazy(
  () => __vitePreload(() => import("./AdminLoginPage-Vy5eA9p3.js"), true ? __vite__mapDeps([8,7,2,9]) : void 0).then((m) => ({ default: m.AdminLoginPage }))
);
const AdminDashboardPage = reactExports.lazy(
  () => __vitePreload(() => import("./AdminDashboardPage-C60rWNhn.js"), true ? __vite__mapDeps([10,1,2,3,7,6,9]) : void 0).then((m) => ({
    default: m.AdminDashboardPage
  }))
);
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-[60vh] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 w-full max-w-sm px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-3/4 bg-muted/40" }),
