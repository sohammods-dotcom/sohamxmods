import { r as reactExports, j as jsxRuntimeExports, u as useParams, L as Link, S as Skeleton } from "./index-dLbmsOq-.js";
import { P as Package, B as Badge } from "./badge-DNNtDM6x.js";
import { B as Button } from "./button-cFVUO7n4.js";
import { L as Layout, a as ShieldCheck, S as Star, T as TriangleAlert } from "./Layout-C8PHEOpx.js";
import { b as useApp, u as useIncrementDownload, D as Download } from "./useApps-Dp3DwtGU.js";
...
function formatDownloads(count) {
  if (count >= 1e6) return `${(count / 1e6).toFixed(1)}M downloads`;
  if (count >= 1e3) return `${(count / 1e3).toFixed(1)}K downloads`;
  return `${count} downloads`;
}
function getRating(id2) {
  const num = Number.parseInt(id2, 10) || id2.charCodeAt(0);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-28 h-28 rounded-2xl bg-muted/40 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-3 pt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-2/3 bg-muted/40" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-28 bg-muted/30" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-36 bg-muted/30" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-24 bg-muted/30" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-px w-full bg-muted/20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full bg-muted/30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-5/6 bg-muted/30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-4/5 bg-muted/30" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-14 w-full rounded-xl bg-muted/40" })
      ]
    }
  );
}
function AppDetailPage() {
  const { id: id2 } = useParams({ from: "/app/$id" });
  const { data: app, isLoading } = useApp(id2);
  const incrementDownload = useIncrementDownload();
  const [downloading, setDownloading] = reactExports.useState(false);
  const [downloadDone, setDownloadDone] = reactExports.useState(false);
  const handleDownload = async () => {
    ...
    try {
      ...
      setTimeout(() => setDownloadDone(false), 4e3);
    } finally {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        !isLoading && !app && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-14 h-14 text-muted-foreground mx-auto mb-4 opacity-50" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-2", children: "App Not Found" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6 max-w-xs mx-auto", children: "This app may have been removed or the link is invalid." }),
        ...
        !isLoading && app && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glassmorphism neon-border rounded-2xl p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-5 mb-6", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 pt-1 space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h1",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                      [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Star,
                        {
                          className: `w-3.5 h-3.5 ${s <= Math.round(Number(getRating(app.id)) / 2) ? "text-amber-400 fill-amber-400" : "text-muted-foreground"}`
                        },
                        s
                      )),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "w-3.5 h-3.5 text-accent" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-accent", children: formatDownloads(app.downloadCount) })
                        ]
                      }
                    )
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 mb-6" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", "data-ocid": "app_detail.description", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-2", children: "About this app" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/90 leading-relaxed", children: app.description })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mb-6", children: [
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-4 h-4 text-primary mx-auto mb-1.5" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-0.5", children: label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground font-mono truncate", children: value })
                    ]
                  },
                  label
                )) }),
                  ...
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: downloadDone ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-5 h-5" }),
                          "Download Started!"
                        ] }) : downloading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center mt-3", children: "By downloading you agree to our Terms of Use. For legal apps only." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 p-4 rounded-xl border border-amber-500/20 bg-amber-500/5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "w-5 h-5 text-amber-400 shrink-0 mt-0.5" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-200/80 leading-relaxed", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-amber-300", children: "Installation Note:" }),
                  " ",
                  'Enable "Install from Unknown Sources" in Android settings before installing this APK. Scan with an antivirus after download.'
                ] })
              ] })
            ]
          }
